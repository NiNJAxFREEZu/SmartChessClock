...
//FUNKCJE -----------------------------------------------------------------------------------------
int decrement(struct _time* clock)	//Funkcja pomniejszaj�ca struktur� czasu o 1ms
{
...
void increment(struct _time* clock, int secondInc)	//Funkcja inkremetuj�ca struktur� czasow� o zadan� liczb� sekund
{
...
void presetInit()	//INICJALIZACJA PRESET�W CZASOWYCH	WARNING: HARDCODE AHEAD
{
	//BULLET 1+0
